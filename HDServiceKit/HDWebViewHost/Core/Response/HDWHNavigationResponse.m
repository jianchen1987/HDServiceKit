...
wh_doc_code(window.webViewHost.invoke("openExternalUrl",{"url":"https://qian.163.com"}))
...
wh_doc_code_expect("在 App 内的浏览器里打开了’qian.163.com‘ 页面")
wh_doc_end
// clang-format on
...
wh_doc_code(window.webViewHost.invoke('startNewPage', { 'url': 'http://you.163.com/','title': 'title',
    'type': "push",
    'backPageParameter': {
...
wh_doc_code_expect("新开一个 webview 打开’you.163.com‘页面，加载完毕之后，点击返回，返回到 ’qian.163.com‘ 页面")
wh_doc_end
// clang-format on
