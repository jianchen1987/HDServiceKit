...
- (void)drawScanRect {
    ...
    //非扫码区域半透明
    {
        ...
        CGContextSetRGBFillColor(context, red_notRecoginitonAreaColor, green_notRecoginitonAreaColor,
                                 blue_notRecoginitonAreaColor, alpa_notRecoginitonAreaColor);
...
- (void)myCodeClicked {
    if (self.clickedMyQRCodeBlock != nil) {
        self.clickedMyQRCodeBlock();
    }
}
